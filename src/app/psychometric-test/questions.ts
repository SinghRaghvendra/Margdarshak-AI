...
export const psychometricTestSections: Section[] = [
  ...
  },
  {
    ...
    questions: [
        ...
        { id:s2q18: 's2q18', text: 'Which work environment sounds best?', type: 'choice', options: [{id:'a', text:'A busy, bustling hospital or clinic.'}, {id:'b', text:'A quiet, focused research lab.'}, {id:'c', text:'A collaborative and creative design studio.'}, {id:'d', text:'A high-energy, competitive sales floor.'}] },
    ...
    questions: [
        ...
        { id: 's3g8', type: 'choice', text: 'The most powerful motivator for me is:', options: [{id:'a', text:'Autonomy and the freedom to work my own way.'}, {id:'b', text:'The opportunity to lead and manage a team.'}, {id:'c', text:'Mastering a difficult skill or craft.'}, {id:'d', text:'The social status and prestige of my job title.'}] },
        ...
        { id: 's3q14', type:s3q14: 's3q14', text: 'I feel most valued at work when:', type: 'choice', options: [{id:'a', text:'My opinion is sought after and respected.'}, {id:'b', text:'I am given the trust to work independently.'}, {id:'c', text:'My contributions to the team are acknowledged.'}, {id:'d', text:'I receive a promotion or a pay raise.'}] },
  ...
  },
  {
    ...
    questions: [
        ...
        { id: 's4q13', type: 'scenario', scenario: 'The project\'s initial plan has failed.', questionText: 'What is your reaction?', options: [{id:'a', text:'"Let\'s analyze the data to see where the assumption was wrong."' }, {'Let\'s brainstorm some completely new approaches."' , id: 'b'}, {id:'c', text:'"Let\'s go back to the drawing board and create a more detailed plan."' }, {id:'d', text:'"Let\'s see if we can find a quick fix to get back on track."' }] },
  ...
  },
  {
    ...
    questions: [
        ...
        { id:s5q6: 's5q6', type: 'choice', text: 'I work best in a team that:', options: [{id:'a', text:'Challenges each other and debates ideas openly.'}, {id:'b', text:'Is harmonious and avoids confrontation.'}, {id:'c', text:'Is highly organized with clear roles for everyone.'}, {id:'d', text:'Is flexible and adapts roles as needed.'}] },
        ...
        { id: 's5q19', type: 'scenario', scenario: 'The team has to work late.', questionText: 'Your thought is:', options: [{id:'a', text:'"Great! I love the energy of working under pressure together."' }, {'"Annoying, but I\'ll do my part to get it done."' , id: 'b'}, {id:'c', text:'"This is a sign of poor planning."' }, {id:'d', text:'"I hope there\'s free pizza."' }] },
